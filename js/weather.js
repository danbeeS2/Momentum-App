...
const clothes = document.querySelector("#weather span:last-child");
...
function clothesByTemp(temp) {
  ...
  if (temp >= 27) {
    ...
    wear = `모자달린 두꺼운 패딩, 목도리, 귀마개, 부츠, 장갑, 모자`;
  }

  clothes.innerText = wear;
  console.log(temp, wear);
}
